...
def manitulin_test_list(fromcode,tocode,noitems,mcweight,length,width,height,from_loc,to_loc):
  # fromcode="L6T3X4"
  # tocode="E3B4C3"
  ...
  try:
    ...
    # Create a DataFrame for quote records
      ...
      df_road  =pd.DataFrame( [{
        ...
        'ShipDate': datetime.today().strftime('%Y-%m-%d'),
        "QuoteTotal":[json_data['freight_charge']],
        'Delivery Date (Estimated)': json_data['eta_from_pickup_date'],
        'No of days for delivery (Estimated)': json_data['service_days'],
...
# data,tax=manitulin_test_list(fromcode, tocode, noitems, mcweight, length, width, height)
# print(data,tax)