...
from Midland_test import get_rate_quotes_and_charges,get_rate_quotes_and_charges_multiple
import os
from fedex_test import fedex_test, fedex_test_multiple
from Manitulin_test import manitulin_test,manitulin_test_multiple
from Day_and_Ross import day_and_Ross,day_and_Ross_multiple
from ups import ups_rates,ups_rates_multiple
from canada_post import canada_post_rate
from pulorator import pulorator
...
# Update the counter value in the file
    ...
    try:
        if mcweight2 =="":
            print("hi")
            charges_df,quote_records = get_rate_quotes_and_charges(fromcode,tocode,noitems,mcweight,length,width,height)
            ...
            fedex_data,fedex_tax=fedex_test(fromcode,tocode,noitems,mcweight,country,length, width, height)
            ...
            if(fromcode!= None):
                try:
                    manitulin_data,manitulin_tax=manitulin_test(fromcode,tocode,noitems,mcweight,length,width,height)
                    ...
                    print("no data",e)
                DandR_data, DandR_tax=day_and_Ross(fromcode,tocode,noitems,mcweight,length,width,height,from_loc,to_loc)
                ...
                try:
                    print("ups_data")
                    ups_data,ups_tax=ups_rates(fromcode,tocode,noitems,mcweight,length,width,height,from_loc,to_loc)
                ...
                try:
                    ...
                    canada_post_data,canada_post_tax=canada_post_rate(fromcode,tocode,noitems,mcweight,length,width,height,from_loc,to_loc)
                ...
                try:
                    ...
                    purolator_post_data,purolator_post_tax=pulorator(fromcode,tocode,noitems,mcweight,length,width,height,from_loc,to_loc)
